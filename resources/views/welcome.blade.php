  ...
  <div class="container py-4">
    ...
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card h-100 shadow-sm">
          <div class="overflow-hidden">
            <img src="/img/pengumuman1.png" class="card-img-top" alt="Bulan Rosario">
          </div>
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">Bulan Rosario</h5>
            <p class="card-text">Mari bersama-sama menghayati Bulan Rosario dengan doa dan renungan bersama setiap hari Senin dan Kamis pukul 19.00 WIT di Gereja Katedral.</p>
            <div class="mt-auto">
              <a href="#" class="btn btn-dark w-100">Baca Selengkapnya</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card h-100 shadow-sm">
          <div class="overflow-hidden">
            <img src="/img/pengumuman2.png" class="card-img-top" alt="Bulan Maria">
          </div>
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">Pembukaan Bulan Maria 2025</h5>
            <p class="card-text">Syallom, mari hadiri misa pembukaan Bulan Maria tanggal 1 Mei 2025 pukul 19.00 WIT di Gereja Katedral St. Fransiskus Xaverius. Diakhiri dengan Rosario bersama.</p>
            <div class="mt-auto">
              <a href="#" class="btn btn-dark w-100">Baca Selengkapnya</a>
            </div>
          </div>
      ...
      <div class="col-md-4">
        <div class="card h-100 shadow-sm">
          <div class="overflow-hidden">
            <img src="/img/pengumuman3.png" class="card-img-top" alt="Bulan Kitab Suci">
          </div>
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">Bulan Kitab Suci</h5>
            <p class="card-text">Bulan September adalah Bulan Kitab Suci Nasional. Mari gunakan kesempatan ini untuk memperdalam pengetahuan dan iman kita melalui Sabda Tuhan dalam Kitab Suci.</p>
            <div class="mt-auto">
              <a href="#" class="btn btn-dark w-100">Baca Selengkapnya</a>
            </div>
          </div>
...
<section class="py-5 bg-white">
  <div class="container py-4">
    ...
    <div class="row g-4 mt-2">
      <div class="col-lg-6">
        <div class="misa-item d-flex">
          <div class="misa-icon">
            <i class="bi bi-brightness-alt-high"></i>
          </div>
          <div>
            <h5 class="misa-title">Misa Harian</h5>
            <p class="misa-detail mb-2">Senin - Sabtu</p>
            <ul class="misa-schedule">
              <li>05.30 WIT</li>
            </ul>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="misa-item d-flex">
          ...
          <div>
            <h5 class="misa-title">Misa Jumat Pertama</h5>
            <p class="misa-detail mb-2">Jumat Pertama Setiap Bulan</p>
            <ul class="misa-schedule">
              <li>19.30 WIT</li>
            </ul>
          </div>
    ...
    <div class="row g-4 mt-2">
      <div class="col-12">
        <div class="misa-item d-flex">
          ...
          <div>
            <h5 class="misa-title">Misa Minggu</h5>
            <p class="misa-detail mb-2">Hari Sabtu</p>
            <ul class="misa-schedule mb-3">
              <li>16.30 WIT</li>
            </ul>
            <p class="misa-detail mb-2">Hari Minggu</p>
            <ul class="misa-schedule">
              <li>06.00 WIT</li>
              <li>08.30 WIT</li>
              <li>11.00 WIT</li>
              <li>16.30 WIT</li>
              <li class="misa-special">19.00 WIT - Misa Bernuansa Karismatik (tiap Minggu Ke-3)</li>
            </ul>
          </div>
        </div>
      </div>
