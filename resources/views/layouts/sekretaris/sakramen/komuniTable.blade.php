<div class="shadow-sm card">
    ...
    <div class="card-body">
        <div class="table-responsive"> {{-- Tambahan agar tabel bisa di-scroll di layar kecil --}}
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    @foreach ($komuni as $data_komuni)
                        <tr>
                            ...
                            <td>
                                <div class="flex-wrap gap-2 d-flex justify-content-center">
                                    ...
                                    {{-- Konfirmasi --}}
                                    <button type="button" class="border-0 badge bg-success fs-6" data-bs-toggle="modal" data-bs-target="#confirmModalKomuni{{ $data_komuni->id }}">
                                        <i class="fa-solid fa-check"></i> 
                                    </button>
                                    {{-- Tolak --}}
                                    <button type="button" class="border-0 badge bg-danger fs-6" data-bs-toggle="modal" data-bs-target="#rejectModalLabelKomuni{{ $data_komuni->id }}">
                        ...
                        {{-- Modal Konfirmasi --}}
                        <div class="modal fade" id="confirmModalKomuni{{ $data_komuni->id }}" tabindex="-1" aria-labelledby="confirmModalKomuniLabel{{ $data_komuni->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="border-0 shadow modal-content">
                                    <div class="pb-0 border-0 modal-header">
                                        <h5 class="modal-title text-danger fw-bold" id="confirmModalKomuniLabel{{ $data_komuni->id }}">
                                    ...
                                    <div class="pt-0 border-0 modal-footer justify-content-center">
                                        <form action="{{ route('sekretaris.setujuKomuni', $data_komuni->id) }}" method="POST" class="d-inline">
                                            @csrf
                        ...
                        {{-- Modal Tolak --}}
                        <div class="modal fade" id="rejectModalLabelKomuni{{ $data_komuni->id }}" tabindex="-1" aria-labelledby="rejectModalLabelKomuni{{ $data_komuni->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="border-0 shadow modal-content">
                                    <div class="pb-0 border-0 modal-header">
                                        <h5 class="modal-title text-danger fw-bold" id="rejectModalLabelKomuni{{ $data_komuni->id }}">
                                            <i class="fas fa-exclamation-circle"></i> Konfirmasi Data
                                        </h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    ...
                                    <div class="pt-0 border-0 modal-footer justify-content-center">
                                        <form action="{{ route('sekretaris.tolakKomuni', $data_komuni->id) }}" method="POST" class="d-inline">
                                            @csrf
