<div class="shadow-sm card">
    ...
    <div class="card-body">
        {{-- Tambahkan wrapper table-responsive untuk responsivitas --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-wrap gap-2 d-flex justify-content-center">
                                    {{-- Lihat --}}
                                    <a href="{{ route('sekretaris.detailBaptis.penerimaan', $data_baptis->umat->id) }}" class="border-0 badge bg-primary fs-6" title="Lihat" style="text-decoration: none">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="border-0 shadow modal-content">
                                    ...
                                    <div class="pt-0 border-0 modal-footer justify-content-center">
                                        <form action="{{ route('sekretaris.setujuBaptis.penerimaan', $data_baptis->id) }}" method="POST" class="d-inline">
                                            @csrf
                        ...
                        <div class="modal fade" id="rejectModalLabel{{ $data_baptis->id }}" tabindex="-1" aria-labelledby="rejectModalLabel{{ $data_baptis->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="border-0 shadow modal-content">
                                    ...
                                    <div class="pt-0 border-0 modal-footer justify-content-center">
                                        <form action="{{ route('sekretaris.tolakBaptis.penerimaan', $data_baptis->id) }}" method="POST" class="d-inline">
                                            @csrf
