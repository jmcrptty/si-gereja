...
<head>
    ...
    <title>Laporan Keuangan | Paroki St. Fransiskus Xaverius</title>
...
<body>
    ...
    <div class="bg-burgundy py-4 py-md-5 mb-4">
        <div class="container text-center text-white px-3">
            ...
            <h1 class="display-5 mb-2">Laporan Keuangan</h1>
    ...
    <div class="row justify-content-center">
        @forelse($pengumuman['laporan_keuangan'] as $item)
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="badge bg-burgundy">Laporan Keuangan</span>
                        ...
                        <div class="card-text financial-report">
                            {!! $item->content !!}
                        </div>
        ...
        @empty
            <div class="col-12 col-lg-10">
                <div class="alert alert-info text-center p-4">
                    ...
                    <h4>Belum ada laporan keuangan yang dipublikasikan</h4>
