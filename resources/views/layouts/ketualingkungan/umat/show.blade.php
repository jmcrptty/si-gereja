                ...
                <div class="card-body">
                    <form action="" method="">
                        <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        @if ($umat->baptis->surat_baptis)
                                            <a href="{{ route('ketualingkungan.umat.downloadFile', ['type' => 'surat_baptis', 'filename' => basename($umat->baptis->surat_baptis)]) }}"
                                                class="btn btn-outline-primary d-block" target="_blank">
                                                Lihat Surat Baptis
                                            </a>
                                        @else
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div>
                                            @if ($umat->baptis->surat_krisma_wali_baptis)
                                                <a href="{{ route('ketualingkungan.umat.downloadFile', ['type' => 'surat_krisma_wali_baptis', 'filename' => basename($umat->baptis->surat_krisma_wali_baptis)]) }}"
                                                    class="btn btn-outline-primary d-block" target="_blank">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div>
                                            @if ($umat->baptis->surat_pernikahan_wali_baptis)
                                                <a href="{{ route('ketualingkungan.umat.downloadFile', ['type' => 'surat_pernikahan_wali_baptis', 'filename' => basename($umat->baptis->surat_pernikahan_wali_baptis)]) }}"
                                                    class="btn btn-outline-primary d-block" target="_blank">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        @if ($umat->komuni->surat_komuni)
                                            <a href="{{ route('ketualingkungan.umat.downloadFile', ['type' => 'surat_komuni', 'filename' => basename($umat->komuni->surat_komuni)]) }}"
                                                class="btn btn-outline-primary d-block" target="_blank">
                                                Lihat Surat Komuni
                                            </a>
                                        @else
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        @if ($umat->krisma->surat_krisma)
                                            <a href="{{ route('ketualingkungan.umat.downloadFile', ['type' => 'surat_krisma', 'filename' => basename($umat->krisma->surat_krisma)]) }}"
                                                class="btn btn-outline-primary d-block" target="_blank">
                                                Lihat Surat Krisma
                                            </a>
                                        @else
                            ...
                            @if ($umat->pernikahanPria || $umat->pernikahanWanita)
                                @if ($umat->jenis_kelamin == 'Pria')
                                    ...
                                    @else
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div>
                                                @if ($umat->pernikahanPria->akte_file_wanita)
                                                    <a href="{{ route('ketualingkungan.pernikahan.downloadFile', ['type' => 'akte', 'filename' => basename($umat->pernikahanPria->akte_file_wanita)]) }}"
                                                        class="btn btn-outline-primary d-block" target="_blank">
                                ...
                                @elseif ($umat->jenis_kelamin == 'Wanita')
                                    ...
                                    @else
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div>
                                                @if ($umat->pernikahanWanita->akte_file_pria)
                                                    <a href="{{ route('ketualingkungan.pernikahan.downloadFile', ['type' => 'akte', 'filename' => basename($umat->pernikahanWanita->akte_file_pria)]) }}"
                                                        class="btn btn-outline-primary d-block" target="_blank">
                                                        Lihat Akte Kelahiran
                                                    </a>
                                                @else
