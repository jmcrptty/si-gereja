...
<head>
  ...
  <title>Sakramen Pernikahan</title>
...
<div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="6000">
  ...
  <div class="hero-content position-absolute top-50 start-50 translate-middle text-center text-white">
    <h1 class="display-4 mb-4">Persyaratan pernikahan <br>Katedral Merauke</h1>
  </div>
</div>
...
<section class="py-5">
    <div class="container">
        <h3 class="text-center mb-4">Syarat Penerimaan Sakramen pernikaan</h3>
