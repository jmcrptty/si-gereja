...
<div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="6000">
  ...
  <div class="hero-content position-absolute top-50 start-50 translate-middle text-center text-white">
    <h1 class="display-4 mb-4">Persyaratan Krisma <br>Katedral Merauke</h1>
  </div>
</div>
...
<section class="py-5">
    <div class="container">
        <h3 class="text-center mb-4">Syarat Penerimaan Sakramen Krisma</h3>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <!-- Wali Krisma -->
                <h5 class="mb-3">1. Wali Krisma</h5>
                <p>
                    Wali Krisma haruslah seorang Katolik yang sudah menerima sakramen Krisma dan berusia lebih dari 16 tahun. Wali Krisma dapat seorang pria atau wanita, baik sendiri maupun pasangan (suami-istri).
                </p>
                
                <!-- Orang Tua dan Wali Krisma -->
                <h5 class="mb-3">2. Orang Tua dan Wali Krisma</h5>
                <p>
                    Orang tua (suami dan isteri) dan wali Krisma wajib mengikuti pembekalan/rekoleksi sebelum menerima sakramen Krisma. 
                </p>

                <!-- Jadwal Pembekalan/Rekoleksi -->
                <h5 class="mb-3">3. Jadwal Pembekalan/Rekoleksi</h5>
                <p>
                    Jadwal pembekalan/rekoleksi bisa disesuaikan dengan ketersediaan waktu orang tua dan wali Krisma.
                </p>
                ...
                <ul class="list-unstyled ms-4">
                    <li><i class="bi bi-check-circle text-primary"></i> Pendaftaran dan penyerahan dokumen syarat administratif dapat dilakukan langsung melalui tombol Daftar <strong>Online</strong> di bawah ini.</li>
                    <li><i class="bi bi-check-circle text-primary"></i> Surat Krisma akan diberikan pada saat Penerimaan Sakramen Krisma.</li>
                </ul>
                ...
                <ul class="list-unstyled ms-4">
                    ...
                    <li><i class="bi bi-dot text-primary me-2"></i>Fotokopi KTP Orang Tua</li>
                    <li><i class="bi bi-dot text-primary me-2"></i>Surat Nikah Gereja Orang Tua</li>
                    <li><i class="bi bi-dot text-primary me-2"></i>Data Wali Krisma (Katolik)</li>
                    <li><i class="bi bi-dot text-primary me-2"></i>Mengikuti Katekese Krisma</li>
                    <li><i class="bi bi-dot text-primary me-2"></i>Pas Foto 3x4 (2 lembar)</li>
                </ul>
