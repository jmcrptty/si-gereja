...
class PendaftaranKomuni_InvController extends Controller
{
    public function sendEmailPendaftaran(Request $request) {
        ...
        if($umat->status_pendaftaran == 'Diterima'){
            ...
            $sendSmtpEmail = new SendSmtpEmail([
                ...
                'htmlContent' => "
                    <p>Salam damai,</p>
                    <p>Panitia Pendaftaran Gereja Katedral Merauke dengan ini mengirimkan undangan resmi untuk melanjutkan proses <strong>pendaftaran Sakramen Komuni</strong>.</p>
