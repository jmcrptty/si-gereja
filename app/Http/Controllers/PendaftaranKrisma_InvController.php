...
class PendaftaranKrisma_InvController extends Controller
{
    public function sendEmailPendaftaran(Request $request) {
        ...
        if($umat->status_pendaftaran == 'Diterima'){
            ...
            $link = url('krisma/formulir/' . $token); // kalau ubah ini plis ingat untuk ubah routenya di web.php (nama: krisma.create)
            ...
            $sendSmtpEmail = new SendSmtpEmail([
                ...
                'htmlContent' => "
                    <p>Salam damai,</p>
                    <p>Panitia Pendaftaran Gereja Katedral Merauke dengan ini mengirimkan undangan resmi untuk melanjutkan proses <strong>pendaftaran Sakramen Krisma</strong>.</p>
